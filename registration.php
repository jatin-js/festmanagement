...
<body>
        ...
        <div class="container">
                ...
                <div style="margin:0 auto;width:1100px;color:black;color:black" id="block">
                        ...
                        <div id="insideblock">
                                ...
                                <div>
                                        <form action="showlist.php?mode=0" method="post">
                                                <button type="submit" class="btn btn-primary" style="float:left; width:15%; margin-top:20px; margin-left:10px;">Show All Registrations</button>
                                        </form>
                                        <form action="showlist.php?mode=1" method="post">
                                                <button type="submit" class="btn btn-primary" style="float:left; width:15%; margin-top:20px; margin-left:10px;">Show Paid Registrations</button>
                                        </form>
                                        <form action="showlist.php?mode=2" method="post">
                                                <button type="submit" class="btn btn-primary" style="float:left; width:15%; margin-top:20px; margin-left:10px;">Show Online Registrations</button>
                                        </form>
                                </div><br /><br /><br /><br /><br />
                                <div>
                                        <h5>Custom Search</h5>
                                        <form action="showlist.php" method="post">
                                                ...
                                                <select name="college" id="college" style="float:left; width:20%;margin-top:25px; margin-left:15px;">
                                                        <?php
                                                        $clgquery = mysqli_query($link, "SELECT name FROM college");
                                                        while ($row = mysqli_fetch_array($clgquery)) {
                                                                if ($row[0] == "NIT Andhra")
                                        ...
                                        <form action="showlist.php" method="post">
                                                ...
                                                <select name="event" style="float:left; width:20%;margin-top:25px; margin-left:15px;">
                                                        <?php
                                                        $eventquery = mysqli_query($link, 'SELECT name FROM events WHERE name<>"none"');
