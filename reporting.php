        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td> <?php
                    $amntonspot = mysqli_fetch_array(mysqli_query($link, "SELECT SUM( amount ) FROM  `appuser_transactions`"));
                    echo $amntonspot[0]; ?></td>
            </tr>
            <tr>
              <td> No. of Registrations - Admin1 </td>
              <td> <?php
                    $amntadmin1 = mysqli_fetch_array(mysqli_query($link, "SELECT count( regid ) FROM  `appuser_transactions` WHERE appuserid =  'admin1'"));
                    echo $amntadmin1[0]; ?> </td>
            </tr>
            <tr>
              <td> Amount Collected - Admin1 </td>
              <td> <?php
                    $amntadmin1 = mysqli_fetch_array(mysqli_query($link, "SELECT SUM( amount ) FROM  `appuser_transactions` WHERE appuserid =  'admin1'"));
                    echo $amntadmin1[0]; ?> </td>
            </tr>
            <tr>
              <td> No. of Registrations - Admin2 </td>
              <td> <?php
                    $amntadmin1 = mysqli_fetch_array(mysqli_query($link, "SELECT count( regid ) FROM  `appuser_transactions` WHERE appuserid =  'admin2'"));
                    echo $amntadmin1[0]; ?> </td>
            </tr>
            <tr>
              <td> Amount Collected - Admin2 </td>
              <td> <?php
                    $amntadmin2 = mysqli_fetch_array(mysqli_query($link, "SELECT SUM( amount ) FROM  `appuser_transactions` WHERE appuserid =  'admin2'"));
                    echo $amntadmin2[0]; ?> </td>
            </tr>
            <tr>
              <td> No. of Registrations - Admin3 </td>
              <td> <?php
                    $amntadmin1 = mysqli_fetch_array(mysqli_query($link, "SELECT count( regid ) FROM  `appuser_transactions` WHERE appuserid =  'admin3'"));
                    echo $amntadmin1[0]; ?> </td>
            </tr>
            <tr>
              <td> Amount Collected - Admin3 </td>
              <td> <?php
                    $amntadmin3 = mysqli_fetch_array(mysqli_query($link, "SELECT SUM( amount ) FROM  `appuser_transactions` WHERE appuserid =  'admin3'"));
                    echo $amntadmin3[0]; ?> </td>
            </tr>
            <tr>
              <td> No. of Registrations - Day 1 Events </td>
              <td> <?php
                    $nos = mysqli_fetch_array(mysqli_query($link, "SELECT count(a.regid) FROM `appuser_transactions` a, `registration` r, `events` e WHERE a.regid=r.id and r.eventname=e.name and e.timing like '%Day 1%'"));
                    echo $nos[0]; ?> </td>
            </tr>
            <tr>
              <td> Amount Collected - Day 1 Events </td>
              <td> <?php
                    $amnt = mysqli_fetch_array(mysqli_query($link, "SELECT sum(a.amount) FROM `appuser_transactions` a, `registration` r, `events` e WHERE a.regid=r.id and r.eventname=e.name and e.timing like '%Day 1%'"));
                    echo $amnt[0]; ?> </td>
            </tr>
            <tr>
              <td> No. of Registrations - Day 2 Events </td>
              <td> <?php
                    $nos = mysqli_fetch_array(mysqli_query($link, "SELECT count(a.regid) FROM `appuser_transactions` a, `registration` r, `events` e WHERE a.regid=r.id and r.eventname=e.name and e.timing like '%Day 2%'"));
                    echo $nos[0]; ?> </td>
            </tr>
            <tr>
              <td> Amount Collected - Day 2 Events </td>
              <td> <?php
                    $amnt = mysqli_fetch_array(mysqli_query($link, "SELECT sum(a.amount) FROM `appuser_transactions` a, `registration` r, `events` e WHERE a.regid=r.id and r.eventname=e.name and e.timing like '%Day 2%'"));
                    echo $amnt[0]; ?> </td>
            </tr>
            <tr>
              <td> No. of Registrations - Day 3 Events </td>
              <td> <?php
                    $nos = mysqli_fetch_array(mysqli_query($link, "SELECT count(a.regid) FROM `appuser_transactions` a, `registration` r, `events` e WHERE a.regid=r.id and r.eventname=e.name and e.timing like '%Day 3%'"));
                    echo $nos[0]; ?> </td>
            </tr>
            <tr>
              <td> Amount Collected - Day 3 Events </td>
              <td> <?php
                    $amnt = mysqli_fetch_array(mysqli_query($link, "SELECT sum(a.amount) FROM `appuser_transactions` a, `registration` r, `events` e WHERE a.regid=r.id and r.eventname=e.name and e.timing like '%Day 3%'"));
                    echo $amnt[0]; ?> </td>
            </tr>
          </tbody>
        </table>
