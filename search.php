...
if (isset($_POST['usn'])) {
	...
	$query = mysqli_query($link, "SELECT * FROM registration  WHERE usn='$usn'");
} elseif (isset($_POST['regid'])) {
	$regid = clean_string($_POST['regid']);
	$query = mysqli_query($link, "SELECT * FROM registration  WHERE id='$regid'");
} elseif (isset($_POST['name'])) {
	$name = '%' . clean_string($_POST['name']) . '%';
	$query = mysqli_query($link, "SELECT * FROM registration  WHERE name LIKE '$name'");
} else {
	$contactno = clean_string($_POST['contactno']);
	$query = mysqli_query($link, "SELECT * FROM registration  WHERE contactno='$contactno'");
}
?>
<html lang="en">
